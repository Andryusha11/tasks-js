...
//     return arrayMemory;
//   } else if (someType === undefined) {
//     return arrayMemory.sort((a, b) => a.dateTime > b.dateTime);
//   } else {
//     return arrayMemory
//       .filter((el) => el.type === someType)
//       .sort((a, b) => a.dateTime > b.dateTime);
...
// const arr = [
//   { dateTime: new Date(), type: 'error', number: 2 },
//   { dateTime: new Date(), type: 'log', number: 1 },
// ];

// console.log(arr.sort((a, b) => b.dateTime - a.dateTime));
