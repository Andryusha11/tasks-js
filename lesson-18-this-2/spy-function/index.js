...
//algo
// input function which call we want to save
// create array
// withMemory has method callHistory
// return function which repeat functional of input function and will remember all own calls(withMemory)
...
function saveFuncCalls(func) {
  ...
  console.log(history);
  withMemory.callsHistory = history;
  return withMemory;
}
